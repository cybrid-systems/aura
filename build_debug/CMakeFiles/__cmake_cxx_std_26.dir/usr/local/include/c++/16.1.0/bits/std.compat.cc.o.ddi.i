...
# 336 "/usr/local/include/c++/16.1.0/bit" 3
 ...
 {
   do { if (__builtin_expect(!bool(__shift_exponent != __int_traits<_Tp>::__digits), false)) std::__glibcxx_assert_fail("/usr/local/include/c++/16.1.0/bit", 358, __PRETTY_FUNCTION__, "__shift_exponent != __int_traits<_Tp>::__digits"); } while (false);
 }
