...
- [`docs/test_harness_pattern.md`](test_harness_pattern.md) — directory layout (#1932 / #1939)
...
- [`tests/e2e/README.md`](../tests/e2e/README.md) — commercial_readiness E2E (#1934)
...
```bash
python3 tests/migrate_test_layout.py --status
```
