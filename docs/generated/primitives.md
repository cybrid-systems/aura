...
**674** registrations scanned from `src/**/*.cpp`.
...
- **internal-observable**: 210 primitives (31%)
...
### Core builtins (must remain primitive) (193)
...
### Internal observable (stats/counters) (210)
