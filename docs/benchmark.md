...
145 个 LLM 代码生成任务，覆盖基础语法、标准库、类型系统、C FFI、EDSL、Workspace、ADT、functor、所有权、合成管线。
...
|:----|:----:|:-----:|:---------:|:----:|
| **Grok (xAI)** | **121/145** | **83%** | **25/29 (86%)** | **60s** ⚡ |
| DeepSeek v4 Flash | 108/145 | 74% | 22/29 (76%) | 139s |
| MiniMax M2.7 | 34/145 | 23% | 0/29 (0%) | 84s |
