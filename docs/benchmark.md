...
## Latest: 2026-05-20 — deepseek-v4-flash, 57 任务, 44/57 (77%)
...
| `--intend` (C++) | `--rounds 3 --intend` | **44/57 (77%)** | 13 | 0 | 原生 intend + 输出校验 `check_success` |
| `--intend --evolve` | `--rounds 3 --intend --evolve` | 44/57 (77%) | 13 | 0 | E4 自进化 + hints 注入 |
