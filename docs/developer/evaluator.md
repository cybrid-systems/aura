...
- [ ] **§2.4 / §3.2 error returns**: use the centralized `make_merr(k, m)` — old local `merr` lambdas being removed (0.1+; query cluster + mutate:wrap/refactor/extract in 3.1/post).
