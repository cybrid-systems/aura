...
int aura_issue_178_run() {
...

    {
        ...
        std::size_t bytes = 0;
        issue178_roundtrip_populated(original.id, static_cast<std::uint32_t>(original.tag),
                                     original.int_value, original.float_value, original.sym_id,
                                     original.line, original.col, original.type_id, children_data,
                                     3, params_data, 4, annot_data, 2,
