...
static void ac4_schema_1481(CompilerService& cs) {
    std::println("\n--- AC4: schema == 1579 (legacy 1554/1498/1481 ok) ---");
    const auto schema = hash_int_field(cs, "schema");
    CHECK(schema == 1579 || schema == 1554 || schema == 1498 || schema == 1481,
          std::format("schema == 1579 or 1554 or 1498 or 1481 (got {})", schema));
}
