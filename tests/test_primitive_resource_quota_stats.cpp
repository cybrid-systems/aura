...
static void ac4_schema_1481(CompilerService& cs) {
    std::println("\n--- AC4: schema == 1590 (legacy 1579/1554/1498/1481 ok) ---");
    const auto schema = hash_int_field(cs, "schema");
    CHECK(schema == 1618 || schema == 1600 || schema == 1590 || schema == 1579 || schema == 1554 ||
              schema == 1498 || schema == 1481,
          std::format("schema == 1618|1600|1590|1579|1554|1498|1481 (got {})", schema));
}
