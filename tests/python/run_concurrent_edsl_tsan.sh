#!/bin/bash
# run_concurrent_edsl_tsan.sh — Run test_edsl_concurrent_query_mutate
...
#   tests/run_concurrent_edsl_tsan.sh build_tsan_edsl   # custom build dir
#
...
ninja test_edsl_concurrent_query_mutate

# Run. TSan warnings go to stderr; we surface them.
echo "=== Running test_edsl_concurrent_query_mutate under TSan ==="
./test_edsl_concurrent_query_mutate
