...
class TestBlockedPatterns(unittest.TestCase):
    ...
    def test_git_domain_deferred_and_budgeted(self):
        ...
        self.assertEqual(self.m.COMMERCIAL_DOMAIN_BUDGETS["git-"], 17)  # #3615 ship raise (was 14; #3461 gate refresh)
    ...
    def test_synthesize_domain_deferred_and_budgeted(self):
        ...
        self.assertEqual(
            self.m.COMMERCIAL_DOMAIN_BUDGETS["synthesize:"], 14
        )  # #3615 ship raise (was 11; #3461 gate refresh)
    ...
    def test_tcp_domain_deferred_and_budgeted(self):
        ...
        self.assertEqual(
            self.m.COMMERCIAL_DOMAIN_BUDGETS["tcp-"], 19
        )  # #3615 ship raise (was 15; #1975+#2771+#3379/#3380 mergebot + #3461 gate refresh)
    ...
    def test_strategy_domain_deferred_and_budgeted(self):
        ...
        self.assertEqual(
            self.m.COMMERCIAL_DOMAIN_BUDGETS["strategy:"], 14
        )  # #3615 ship raise (was 11; #3461 gate refresh)
    ...
    def test_m4_domain_deferred_and_budgeted(self):
        ...
        self.assertEqual(self.m.COMMERCIAL_DOMAIN_BUDGETS["m4-"], 13)  # #3615 ship raise (was 10; #3461 gate refresh)
    ...
    def test_m4_commercial_budget_overrun_fails_strict(self):
        budget = self.m.COMMERCIAL_DOMAIN_BUDGETS["m4-"]
        fake = [f"m4-synthetic-{i}" for i in range(budget + 1)]
        rc = self.m.run_strict_checks(fake + ["query:root"], stats_names=[])
        self.assertEqual(rc, 1)
