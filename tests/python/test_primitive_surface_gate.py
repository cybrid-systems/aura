...
class TestBlockedPatterns(unittest.TestCase):
    ...
    def test_git_domain_deferred_and_budgeted(self):
        ...
        self.assertEqual(self.m.COMMERCIAL_DOMAIN_BUDGETS["git-"], 10)
    ...
    def test_synthesize_domain_deferred_and_budgeted(self):
        ...
        self.assertEqual(self.m.COMMERCIAL_DOMAIN_BUDGETS["synthesize:"], 7)
    ...
    def test_tcp_domain_deferred_and_budgeted(self):
        ...
        self.assertEqual(self.m.COMMERCIAL_DOMAIN_BUDGETS["tcp-"], 11)  # #1975+#2771
    ...
    def test_strategy_domain_deferred_and_budgeted(self):
        ...
        self.assertEqual(self.m.COMMERCIAL_DOMAIN_BUDGETS["strategy:"], 7)
    ...
    def test_m4_domain_deferred_and_budgeted(self):
        ...
        self.assertEqual(self.m.COMMERCIAL_DOMAIN_BUDGETS["m4-"], 6)
