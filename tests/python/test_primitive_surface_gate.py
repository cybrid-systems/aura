...
class TestBlockedPatterns(unittest.TestCase):
    ...
    def test_slim_surface_budgets(self):
        ...
        self.assertLessEqual(self.m.INTERIM_HARD_CEILING, 538)  # #3946-#3957 wave +1 (full-gate scan)
    ...
    def test_git_domain_deferred_and_budgeted(self):
        ...
        self.assertEqual(
            self.m.COMMERCIAL_DOMAIN_BUDGETS["git-"], 33
    ...
    def test_synthesize_domain_deferred_and_budgeted(self):
        ...
        self.assertEqual(
            ...
            31,  # 3867 wave +1 (the closures shard conversion); #3963 sharded-lock wave +1; #3946-#3957 wave +1 (full-gate scan)
    ...
    def test_tcp_domain_deferred_and_budgeted(self):
        ...
        self.assertEqual(
            ...
            36,  # 3867 wave +1 (the closures shard conversion); #3963 sharded-lock wave +1; #3946-#3957 wave +1 (full-gate scan)
    ...
    def test_m4_domain_deferred_and_budgeted(self):
        ...
        self.assertEqual(
            ...
            29,  # 3867 wave +1 (the closures shard conversion); #3946-#3957 wave +1 (full-gate scan)
