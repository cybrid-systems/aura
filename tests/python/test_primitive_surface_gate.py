...
class TestBlockedPatterns(unittest.TestCase):
    ...
    def test_slim_surface_budgets(self):
        ...
        self.assertLessEqual(self.m.INTERIM_HARD_CEILING, 535)
    ...
    def test_git_domain_deferred_and_budgeted(self):
        ...
        self.assertEqual(
            self.m.COMMERCIAL_DOMAIN_BUDGETS["git-"], 30
        )  # 2026-09-17 wave +1 (the #3854-#3856 ships; was 22; 2026-09-16 wave +1 per CI run 35071333280); #3867 wave +1 (the closures shard conversion)
    ...
    def test_m4_domain_deferred_and_budgeted(self):
        ...
        self.assertEqual(
            ...
            26,  # 3867 wave +1 (the closures shard conversion)
