...
static void ac3_query_schema_1604() {
    ...
    CHECK(schema == 1660 || schema == 1632 || schema == 1627 || schema == 1626 || schema == 1607 ||
              schema == 1604 || schema == 1598,
          std::format("schema 1660|1632|1627|1626|1607|1604|1598 (got {})", schema));
