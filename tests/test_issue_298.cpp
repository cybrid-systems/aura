...
static bool extract_4tuple(aura::compiler::CompilerService& cs,
    ...
    if (!aura::compiler::types::is_int(p3.cdr)) return false;
...
bool test_ratio_basis_points() {
    ...
    CHECK(e1 >= 0 && e1 <= 10000,
          "ratio in [0, 10000] (got " + std::to_string(e1) + ")");
    return true;
}
...
int aura_issue_298_run() { return test_298_detail::run_tests(); }

#ifndef AURA_ISSUE_BUNDLE_MEMBER
int main() { return aura_issue_298_run(); }
#endif
