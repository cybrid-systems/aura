...
| File | Role | Build |
|------|------|--------|
| `test_arena_batch.cpp` | Family batch: #1621 #405 #1662 #546 #1546/#1554 | `EXCLUDE_FROM_ALL` — `ninja test_arena_batch` (kept separate for on-demand debug; do not mega-merge) |
...
| `test_arena_defrag_concurrent.cpp` | Default-build concurrent defrag (#1390) | in `all_test_issue_targets` (CMakeLists.txt) |
