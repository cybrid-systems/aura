...
int main() {
    ...
    std::println("=== test_misc_issue_fold_batch (154 members) ===");
    ...
    if (run_test_anonymous_residual_stable_id_policy_2605() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL member test_anonymous_residual_stable_id_policy_2605 (checks: {} "
                     "passed, {} failed)",
                     g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_aura_jit_unused_fn_lock_2475() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL member test_aura_jit_unused_fn_lock_2475 (checks: {} passed, {} failed)",
                     g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_closure_call_must_deopt_toctou_2472() != 0 || g_failed != 0) {
        ++members_failed;
        std::println(
            "FAIL member test_closure_call_must_deopt_toctou_2472 (checks: {} passed, {} failed)",
            g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_comprehensive_live_closure_expire_2042() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL member test_comprehensive_live_closure_expire_2042 (checks: {} passed, "
                     "{} failed)",
                     g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_dce_elided_deopt_meta_2611() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL member test_dce_elided_deopt_meta_2611 (checks: {} passed, {} failed)",
                     g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_emit_object_deprecated_2477() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL member test_emit_object_deprecated_2477 (checks: {} passed, {} failed)",
                     g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_force_jit_repromote_2502() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL member test_force_jit_repromote_2502 (checks: {} passed, {} failed)",
                     g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_ir_const_string_intern_2573() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL member test_ir_const_string_intern_2573 (checks: {} passed, {} failed)",
                     g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_ir_optimize_type_info_chain_2471() != 0 || g_failed != 0) {
        ++members_failed;
        std::println(
            "FAIL member test_ir_optimize_type_info_chain_2471 (checks: {} passed, {} failed)",
            g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_jit_dual_string_heap_2575() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL member test_jit_dual_string_heap_2575 (checks: {} passed, {} failed)",
                     g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_jit_interpreter_equivalence_oracle_2210() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL member test_jit_interpreter_equivalence_oracle_2210 (checks: {} passed, "
                     "{} failed)",
                     g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_jit_macro_deopt_hygiene_2100() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL member test_jit_macro_deopt_hygiene_2100 (checks: {} passed, {} failed)",
                     g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_live_closure_stable_id_only_2369() != 0 || g_failed != 0) {
        ++members_failed;
        std::println(
            "FAIL member test_live_closure_stable_id_only_2369 (checks: {} passed, {} failed)",
            g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_must_deopt_before_next_call_2128() != 0 || g_failed != 0) {
        ++members_failed;
        std::println(
            "FAIL member test_must_deopt_before_next_call_2128 (checks: {} passed, {} failed)",
            g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_named_closure_stable_id_at_create_2550() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL member test_named_closure_stable_id_at_create_2550 (checks: {} passed, "
                     "{} failed)",
                     g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_partial_recompile_single_evict_2476() != 0 || g_failed != 0) {
        ++members_failed;
        std::println(
            "FAIL member test_partial_recompile_single_evict_2476 (checks: {} passed, {} failed)",
            g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_primcall_narg_2576() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL member test_primcall_narg_2576 (checks: {} passed, {} failed)", g_passed,
                     g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_primcall_str_intern_2577() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL member test_primcall_str_intern_2577 (checks: {} passed, {} failed)",
                     g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_region_priority_deopt_throttle_2132() != 0 || g_failed != 0) {
        ++members_failed;
        std::println(
            "FAIL member test_region_priority_deopt_throttle_2132 (checks: {} passed, {} failed)",
            g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_remount_force_deopt_2503() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL member test_remount_force_deopt_2503 (checks: {} passed, {} failed)",
                     g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_source_to_ir_desync_recovery_2206() != 0 || g_failed != 0) {
        ++members_failed;
        std::println(
            "FAIL member test_source_to_ir_desync_recovery_2206 (checks: {} passed, {} failed)",
            g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_source_to_ir_map_consistency_2045() != 0 || g_failed != 0) {
        ++members_failed;
        std::println(
            "FAIL member test_source_to_ir_map_consistency_2045 (checks: {} passed, {} failed)",
            g_passed, g_failed);
    } else {
        ++members_passed;
    ...
    if (run_test_tree_walker_fallback_strict_2213() != 0 || g_failed != 0) {
        ++members_failed;
        std::println(
            "FAIL member test_tree_walker_fallback_strict_2213 (checks: {} passed, {} failed)",
            g_passed, g_failed);
    } else {
        ++members_passed;
