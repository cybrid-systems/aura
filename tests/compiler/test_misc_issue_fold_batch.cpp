// test_misc_issue_fold_batch.cpp — leftover issue-suffixed tests (W_other)
// Policy: tests/HOMES.md — fold into a thematic suite when a home appears.
...
int main() {
    ...
    std::println("=== test_misc_issue_fold_batch (189 members) ===");
    ...
    if (run_test_gc_defer_mutation_hold_2204() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_gc_defer_mutation_hold_2204");
    } else {
        ++members_passed;
        std::println("OK test_gc_defer_mutation_hold_2204 ({} checks)", g_passed);
    }
    ...
    if (run_test_validate_post_restore_soa_2391() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_validate_post_restore_soa_2391");
    } else {
        ++members_passed;
        std::println("OK test_validate_post_restore_soa_2391 ({} checks)", g_passed);
    }
    ...
    if (run_test_hot_children_columnar_2614() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_hot_children_columnar_2614");
    } else {
        ++members_passed;
        std::println("OK test_hot_children_columnar_2614 ({} checks)", g_passed);
    }
    ...
    if (run_test_mutation_safety_snapshot_steal_2184() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_mutation_safety_snapshot_steal_2184");
    } else {
        ++members_passed;
        std::println("OK test_mutation_safety_snapshot_steal_2184 ({} checks)", g_passed);
    }
    ...
    if (run_test_boundary_yield_steal_metrics_2119() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_boundary_yield_steal_metrics_2119");
    } else {
        ++members_passed;
        std::println("OK test_boundary_yield_steal_metrics_2119 ({} checks)", g_passed);
    }
    ...
    if (run_test_orch_agent_mutation_boundary_2118() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_orch_agent_mutation_boundary_2118");
    } else {
        ++members_passed;
        std::println("OK test_orch_agent_mutation_boundary_2118 ({} checks)", g_passed);
    }
    ...
    if (run_test_orch_soft_boundary_unified_2515() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_orch_soft_boundary_unified_2515");
    } else {
        ++members_passed;
        std::println("OK test_orch_soft_boundary_unified_2515 ({} checks)", g_passed);
    }
    ...
    if (run_test_yield_while_mutation_held_2200() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_yield_while_mutation_held_2200");
    } else {
        ++members_passed;
        std::println("OK test_yield_while_mutation_held_2200 ({} checks)", g_passed);
    }
    ...
    if (run_test_depth_safe_mutation_boundary_steal_2115() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_depth_safe_mutation_boundary_steal_2115");
    } else {
        ++members_passed;
        std::println("OK test_depth_safe_mutation_boundary_steal_2115 ({} checks)", g_passed);
    }
    ...
    if (run_test_dirty_aware_shape_linear_passes_2130() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_dirty_aware_shape_linear_passes_2130");
    } else {
        ++members_passed;
        std::println("OK test_dirty_aware_shape_linear_passes_2130 ({} checks)", g_passed);
    }
    ...
    if (run_test_mutation_guard_try_acquire_2124() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_mutation_guard_try_acquire_2124");
    } else {
        ++members_passed;
        std::println("OK test_mutation_guard_try_acquire_2124 ({} checks)", g_passed);
    }
    ...
    if (run_test_soa_partial_desync_gate_2181() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_soa_partial_desync_gate_2181");
    } else {
        ++members_passed;
        std::println("OK test_soa_partial_desync_gate_2181 ({} checks)", g_passed);
    }
    ...
    if (run_test_tree_walker_fallback_strict_2213() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_tree_walker_fallback_strict_2213");
    } else {
        ++members_passed;
        std::println("OK test_tree_walker_fallback_strict_2213 ({} checks)", g_passed);
    }
    ...
    if (run_test_mutation_log_pressure_2201() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_mutation_log_pressure_2201");
    } else {
        ++members_passed;
        std::println("OK test_mutation_log_pressure_2201 ({} checks)", g_passed);
    }
    ...
    if (run_test_hot_pass_dirty_soa_2060() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_hot_pass_dirty_soa_2060");
    } else {
        ++members_passed;
        std::println("OK test_hot_pass_dirty_soa_2060 ({} checks)", g_passed);
    }
    ...
    if (run_test_source_to_ir_map_consistency_2045() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_source_to_ir_map_consistency_2045");
    } else {
        ++members_passed;
        std::println("OK test_source_to_ir_map_consistency_2045 ({} checks)", g_passed);
    }
    ...
    if (run_test_anonymous_residual_stable_id_policy_2605() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_anonymous_residual_stable_id_policy_2605");
    } else {
        ++members_passed;
        std::println("OK test_anonymous_residual_stable_id_policy_2605 ({} checks)", g_passed);
    }
    ...
    if (run_test_shape_high_mutation_storm_2433() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_shape_high_mutation_storm_2433");
    } else {
        ++members_passed;
        std::println("OK test_shape_high_mutation_storm_2433 ({} checks)", g_passed);
    }
    ...
    if (run_test_outermost_exit_order_2120() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_outermost_exit_order_2120");
    } else {
        ++members_passed;
        std::println("OK test_outermost_exit_order_2120 ({} checks)", g_passed);
    }
    ...
    if (run_test_jit_dual_string_heap_2575() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_jit_dual_string_heap_2575");
    } else {
        ++members_passed;
        std::println("OK test_jit_dual_string_heap_2575 ({} checks)", g_passed);
    }
    ...
    if (run_test_mutation_hold_estimate_2405() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_mutation_hold_estimate_2405");
    } else {
        ++members_passed;
        std::println("OK test_mutation_hold_estimate_2405 ({} checks)", g_passed);
    }
    ...
    if (run_test_typed_mutation_audit_decision_2281() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_typed_mutation_audit_decision_2281");
    } else {
        ++members_passed;
        std::println("OK test_typed_mutation_audit_decision_2281 ({} checks)", g_passed);
    }
    ...
    if (run_test_soa_generation_fence_2111() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_soa_generation_fence_2111");
    } else {
        ++members_passed;
        std::println("OK test_soa_generation_fence_2111 ({} checks)", g_passed);
    }
    ...
    if (run_test_named_closure_stable_id_at_create_2550() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_named_closure_stable_id_at_create_2550");
    } else {
        ++members_passed;
        std::println("OK test_named_closure_stable_id_at_create_2550 ({} checks)", g_passed);
    }
    ...
    if (run_test_ir_const_string_intern_2573() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_ir_const_string_intern_2573");
    } else {
        ++members_passed;
        std::println("OK test_ir_const_string_intern_2573 ({} checks)", g_passed);
    }
    ...
    if (run_test_comprehensive_live_closure_expire_2042() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_comprehensive_live_closure_expire_2042");
    } else {
        ++members_passed;
        std::println("OK test_comprehensive_live_closure_expire_2042 ({} checks)", g_passed);
    }
    ...
    if (run_test_closure_call_must_deopt_toctou_2472() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_closure_call_must_deopt_toctou_2472");
    } else {
        ++members_passed;
        std::println("OK test_closure_call_must_deopt_toctou_2472 ({} checks)", g_passed);
    }
    ...
    if (run_test_mutation_contention_2040() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_mutation_contention_2040");
    } else {
        ++members_passed;
        std::println("OK test_mutation_contention_2040 ({} checks)", g_passed);
    }
    ...
    if (run_test_remount_force_deopt_2503() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_remount_force_deopt_2503");
    } else {
        ++members_passed;
        std::println("OK test_remount_force_deopt_2503 ({} checks)", g_passed);
    }
    ...
    if (run_test_jit_macro_deopt_hygiene_2100() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_jit_macro_deopt_hygiene_2100");
    } else {
        ++members_passed;
        std::println("OK test_jit_macro_deopt_hygiene_2100 ({} checks)", g_passed);
    }
    ...
    if (run_test_primcall_narg_2576() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_primcall_narg_2576");
    } else {
        ++members_passed;
        std::println("OK test_primcall_narg_2576 ({} checks)", g_passed);
    }
    ...
    if (run_test_mutation_memory_blame_2196() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_mutation_memory_blame_2196");
    } else {
        ++members_passed;
        std::println("OK test_mutation_memory_blame_2196 ({} checks)", g_passed);
    }
    ...
    if (run_test_shape_compact_storm_isolation_2617() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_shape_compact_storm_isolation_2617");
    } else {
        ++members_passed;
        std::println("OK test_shape_compact_storm_isolation_2617 ({} checks)", g_passed);
    }
    ...
    if (run_test_storm_isolation_2236() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_storm_isolation_2236");
    } else {
        ++members_passed;
        std::println("OK test_storm_isolation_2236 ({} checks)", g_passed);
    }
    ...
    if (run_test_source_to_ir_desync_recovery_2206() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_source_to_ir_desync_recovery_2206");
    } else {
        ++members_passed;
        std::println("OK test_source_to_ir_desync_recovery_2206 ({} checks)", g_passed);
    }
    ...
    if (run_test_mutation_hold_hard_timeout_2199() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_mutation_hold_hard_timeout_2199");
    } else {
        ++members_passed;
        std::println("OK test_mutation_hold_hard_timeout_2199 ({} checks)", g_passed);
    }
    ...
    if (run_test_partial_recompile_single_evict_2476() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_partial_recompile_single_evict_2476");
    } else {
        ++members_passed;
        std::println("OK test_partial_recompile_single_evict_2476 ({} checks)", g_passed);
    }
    ...
    if (run_test_effect_epoch_mutation_unify_2149() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_effect_epoch_mutation_unify_2149");
    } else {
        ++members_passed;
        std::println("OK test_effect_epoch_mutation_unify_2149 ({} checks)", g_passed);
    }
    ...
    if (run_test_must_deopt_before_next_call_2128() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_must_deopt_before_next_call_2128");
    } else {
        ++members_passed;
        std::println("OK test_must_deopt_before_next_call_2128 ({} checks)", g_passed);
    }
    ...
    if (run_test_live_closure_stable_id_only_2369() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_live_closure_stable_id_only_2369");
    } else {
        ++members_passed;
        std::println("OK test_live_closure_stable_id_only_2369 ({} checks)", g_passed);
    }
    ...
    if (run_test_soa_residual_production_smoke_2618() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_soa_residual_production_smoke_2618");
    } else {
        ++members_passed;
        std::println("OK test_soa_residual_production_smoke_2618 ({} checks)", g_passed);
    }
    ...
    if (run_test_region_priority_deopt_throttle_2132() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_region_priority_deopt_throttle_2132");
    } else {
        ++members_passed;
        std::println("OK test_region_priority_deopt_throttle_2132 ({} checks)", g_passed);
    }
    ...
    if (run_test_soa_single_entry_dirty_sync_2139() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_soa_single_entry_dirty_sync_2139");
    } else {
        ++members_passed;
        std::println("OK test_soa_single_entry_dirty_sync_2139 ({} checks)", g_passed);
    }
    ...
    if (run_test_guard_exit_occurrence_refresh_2144() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_guard_exit_occurrence_refresh_2144");
    } else {
        ++members_passed;
        std::println("OK test_guard_exit_occurrence_refresh_2144 ({} checks)", g_passed);
    }
    ...
    if (run_test_primcall_str_intern_2577() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_primcall_str_intern_2577");
    } else {
        ++members_passed;
        std::println("OK test_primcall_str_intern_2577 ({} checks)", g_passed);
    }
    ...
    if (run_test_aura_jit_unused_fn_lock_2475() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_aura_jit_unused_fn_lock_2475");
    } else {
        ++members_passed;
        std::println("OK test_aura_jit_unused_fn_lock_2475 ({} checks)", g_passed);
    }
    ...
    if (run_test_jit_interpreter_equivalence_oracle_2210() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_jit_interpreter_equivalence_oracle_2210");
    } else {
        ++members_passed;
        std::println("OK test_jit_interpreter_equivalence_oracle_2210 ({} checks)", g_passed);
    }
    ...
    if (run_test_emit_object_deprecated_2477() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_emit_object_deprecated_2477");
    } else {
        ++members_passed;
        std::println("OK test_emit_object_deprecated_2477 ({} checks)", g_passed);
    }
    ...
    if (run_test_soa_dirty_aware_pipeline_2143() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_soa_dirty_aware_pipeline_2143");
    } else {
        ++members_passed;
        std::println("OK test_soa_dirty_aware_pipeline_2143 ({} checks)", g_passed);
    }
    ...
    if (run_test_soa_ban_residual_aos_bridge_2520() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_soa_ban_residual_aos_bridge_2520");
    } else {
        ++members_passed;
        std::println("OK test_soa_ban_residual_aos_bridge_2520 ({} checks)", g_passed);
    }
    ...
    if (run_test_force_jit_repromote_2502() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_force_jit_repromote_2502");
    } else {
        ++members_passed;
        std::println("OK test_force_jit_repromote_2502 ({} checks)", g_passed);
    }
    ...
    if (run_test_mutation_hold_live_2517() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_mutation_hold_live_2517");
    } else {
        ++members_passed;
        std::println("OK test_mutation_hold_live_2517 ({} checks)", g_passed);
    }
    ...
    if (run_test_shape_storm_adaptive_2526() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_shape_storm_adaptive_2526");
    } else {
        ++members_passed;
        std::println("OK test_shape_storm_adaptive_2526 ({} checks)", g_passed);
    }
    ...
    if (run_test_ir_optimize_type_info_chain_2471() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_ir_optimize_type_info_chain_2471");
    } else {
        ++members_passed;
        std::println("OK test_ir_optimize_type_info_chain_2471 ({} checks)", g_passed);
    }
    ...
    if (run_test_predicate_memo_boundary_selective_2104() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_predicate_memo_boundary_selective_2104");
    } else {
        ++members_passed;
        std::println("OK test_predicate_memo_boundary_selective_2104 ({} checks)", g_passed);
    }
    ...
    if (run_test_post_steal_linear_revalidate_2197() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_post_steal_linear_revalidate_2197");
    } else {
        ++members_passed;
        std::println("OK test_post_steal_linear_revalidate_2197 ({} checks)", g_passed);
    }
    ...
    if (run_test_dce_elided_deopt_meta_2611() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_dce_elided_deopt_meta_2611");
    } else {
        ++members_passed;
        std::println("OK test_dce_elided_deopt_meta_2611 ({} checks)", g_passed);
    }
    ...
    if (run_test_mutation_hold_slo_2349() != 0 || g_failed != 0) {
        ++members_failed;
        std::println("FAIL test_mutation_hold_slo_2349");
    } else {
        ++members_passed;
        std::println("OK test_mutation_hold_slo_2349 ({} checks)", g_passed);
    }
