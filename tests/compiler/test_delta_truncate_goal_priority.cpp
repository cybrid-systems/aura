...
static void ac5_query_and_source() {
    ...
    CHECK(cmake.find("test_delta_truncate_goal_priority") != std::string::npos,
          "AC5: cmake target");
...
int run_test_delta_truncate_goal_priority() {
    std::println("test_delta_truncate_goal_priority");
...
int main() {
    return run_test_delta_truncate_goal_priority();
}
#endif
