...
static void ac5_hard_gate_retained() {
    ...
    CHECK(read_file("tests/compiler/test_adt_hard_gate_exhaustiveness_2264.cpp").size() > 0 ||
              read_file("tests/compiler/test_adt_exhaustiveness_audit_2223.cpp").size() > 0,
