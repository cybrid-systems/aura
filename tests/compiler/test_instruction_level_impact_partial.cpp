...
static void ac5_source_and_happy_path() {
    ...
    auto self = read_file("tests/compiler/test_instruction_level_impact_partial.cpp");
...
int run_test_instruction_level_impact_partial() {
...
int main() {
    return run_test_instruction_level_impact_partial();
}
#endif
