...
static void ac5_ac6_lineage_and_contract() {
    ...
    const auto t2123 = read_file("tests/compiler/test_query_pattern_default_hygiene.cpp");
...
int run_test_query_hygiene_default() {
...
int main() {
    return run_test_query_hygiene_default();
}
#endif
