...
static void ac5_schema_and_source() {
    ...
    CHECK(cmake.find("test_exhausted_min_dirty_reemit") != std::string::npos, "AC5: cmake target");
}
...
static void ac2601_schema_and_source() {
    ...
    CHECK(cmake.find("test_exhausted_min_dirty_reemit") != std::string::npos,
...
int main() {
    return run_test_exhausted_min_dirty_reemit();
}
#endif
