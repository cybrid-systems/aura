...
static void ac5_source_and_schema() {
    ...
    CHECK(cmake.find("test_composite_cs_signature_matrix") != std::string::npos, "AC5: cmake");
...
int run_test_composite_cs_signature_matrix() {
    std::println("test_composite_cs_signature_matrix");
...
int main() {
    return run_test_composite_cs_signature_matrix();
}
#endif
