...
int run_test_linear_enforce_production_defaults() {
...

    {
        ...
        // Issue #3818: #3472 post-persist deny must share #3545 undo.
        {
...
int main() {
    return run_test_linear_enforce_production_defaults();
}
#endif
