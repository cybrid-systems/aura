...
static void ac5_source_cite_unified_gate() {
    ...
    const auto linter_path = "scripts/coverage/manifests/2499.json";
...
int run_test_root_remap_pin_contract_unified() {
...
int main() {
    return run_test_root_remap_pin_contract_unified();
}
#endif
