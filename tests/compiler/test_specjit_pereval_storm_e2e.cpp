...
static void ac5_concurrent_and_source_gate() {
    ...
    const auto script = read_file("scripts/coverage/manifests/2504.json");
...
int run_test_specjit_pereval_storm_e2e() {
    std::println("test_specjit_pereval_storm_e2e");
...
int main() {
    return run_test_specjit_pereval_storm_e2e();
}
#endif
