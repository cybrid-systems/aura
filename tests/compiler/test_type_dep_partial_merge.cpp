// test_type_dep_partial_merge.cpp
...
namespace _2283_detail {
    ...
    static void run_2283_type_dep_partial_merge() {
        ...
        // #81967 — the canonical src-aligned suite — NOT tests/issues/.)
        {
            ...
            std::println("  path: tests/compiler/test_type_dep_partial_merge.cpp");
...
int run_test_type_dep_partial_merge() {
...
int main() {
    return run_test_type_dep_partial_merge();
}
#endif
