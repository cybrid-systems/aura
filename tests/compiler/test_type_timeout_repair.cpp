...
namespace _2284_detail {
    ...
    static void run_2284_timeout_repair() {
        ...
        // #81967 — the canonical src-aligned suite — NOT tests/issues/.)
        {
            ...
            std::println("  path: tests/compiler/test_type_timeout_repair.cpp");
...
int run_test_type_timeout_repair() {
...
int main() {
    return run_test_type_timeout_repair();
}
#endif
