...
| `tests/core/test_*.cpp` | 463 | Preferred destination suites |
| **Total scanned** | **463** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 129 | 129 | P0 — high volume; strong domain suite foothold |
