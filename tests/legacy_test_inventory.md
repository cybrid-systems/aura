...
| `tests/core/test_*.cpp` | 492 | Preferred destination suites |
| **Total scanned** | **492** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 143 | 143 | P0 — high volume; strong domain suite foothold |
...
### `mutation_dirty` — Mutation / dirty propagation / provenance (143)
