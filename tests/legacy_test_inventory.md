...
| `tests/core/test_*.cpp` | 598 | Preferred destination suites |
| **Total scanned** | **598** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 170 | 170 | P0 — high volume; strong domain suite foothold |
