...
| `tests/core/test_*.cpp` | 599 | Preferred destination suites |
| **Total scanned** | **599** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 171 | 171 | P0 — high volume; strong domain suite foothold |
...
| `shape_soa` | Shape / SoA / column layout | 0 | 0 | 26 | 26 | P2 — small-medium; soa_batch precedent |
...
### `arena_compaction` — Arena / compaction / GC (67)
...
### `mutation_dirty` — Mutation / dirty propagation / provenance (171)
