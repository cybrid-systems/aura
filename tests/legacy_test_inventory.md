...
| `tests/core/test_*.cpp` | 495 | Preferred destination suites |
| **Total scanned** | **495** | |
...
| `jit_incremental` | JIT / AOT / incremental relower | 0 | 0 | 54 | 54 | P2 — link-profile heavy; migrate AC smoke first |
...
### `jit_incremental` — JIT / AOT / incremental relower (54)
