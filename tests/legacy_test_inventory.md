...
| `tests/core/test_*.cpp` | 692 | Preferred destination suites |
| **Total scanned** | **692** | |
...
| `fiber_orch` | Fiber / orchestration / steal / Guard | 0 | 0 | 74 | 74 | P1 — domain suite already collapses many obs gates |
...
### `fiber_orch` — Fiber / orchestration / steal / Guard (74)
