...
| `tests/core/test_*.cpp` | 391 | Preferred destination suites |
| **Total scanned** | **391** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 109 | 109 | P0 — high volume; strong domain suite foothold |
