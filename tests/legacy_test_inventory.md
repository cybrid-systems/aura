...
| `tests/core/test_*.cpp` | 654 | Preferred destination suites |
| **Total scanned** | **654** | |
...
| `uncategorized` | Uncategorized / mixed | 0 | 0 | 37 | 37 | P3 — review case-by-case |
...
### `uncategorized` — Uncategorized / mixed (37)
