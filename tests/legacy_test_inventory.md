...
**Generated:** 2026-07-23 by `scripts/inventory_legacy_tests.py`
...
| `tests/test_*.cpp` (issue-oriented) | 2 | Numbered root tests + `*_batch` drivers |
...
| `jit_incremental` | JIT / AOT / incremental relower | 0 | 2 | 0 | 2 | P2 — link-profile heavy; migrate AC smoke first |
...
### `jit_incremental` — JIT / AOT / incremental relower (2)
