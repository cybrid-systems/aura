...
| `tests/core/test_*.cpp` | 636 | Preferred destination suites |
| **Total scanned** | **636** | |
...
| `shape_soa` | Shape / SoA / column layout | 0 | 0 | 39 | 39 | P2 — small-medium; soa_batch precedent |
...
### `shape_soa` — Shape / SoA / column layout (39)
