...
| `tests/core/test_*.cpp` | 815 | Preferred destination suites |
| **Total scanned** | **815** | |
...
| `shape_soa` | Shape / SoA / column layout | 0 | 0 | 51 | 51 | P2 — small-medium; soa_batch precedent |
...
### `shape_soa` — Shape / SoA / column layout (51)
