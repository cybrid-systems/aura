...
| `tests/core/test_*.cpp` | 413 | Preferred destination suites |
| **Total scanned** | **413** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 116 | 116 | P0 — high volume; strong domain suite foothold |
...
### `arena_compaction` — Arena / compaction / GC (40)
...
### `mutation_dirty` — Mutation / dirty propagation / provenance (116)
...
### `jit_incremental` — JIT / AOT / incremental relower (42)
...
### `observability` — Observability / metrics / query:*-stats (96)
