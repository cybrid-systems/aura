...
**Generated:** 2026-07-26 by `scripts/inventory_legacy_tests.py`
...
| `tests/core/test_*.cpp` | 428 | Preferred destination suites |
| **Total scanned** | **428** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 118 | 118 | P0 — high volume; strong domain suite foothold |
...
### `arena_compaction` — Arena / compaction / GC (43)
...
### `shape_soa` — Shape / SoA / column layout (18)
...
### `observability` — Observability / metrics / query:*-stats (102)
