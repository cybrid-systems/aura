...
| `tests/core/test_*.cpp` | 684 | Preferred destination suites |
| **Total scanned** | **684** | |
...
| `fiber_orch` | Fiber / orchestration / steal / Guard | 0 | 0 | 71 | 71 | P1 — domain suite already collapses many obs gates |
...
### `fiber_orch` — Fiber / orchestration / steal / Guard (71)
