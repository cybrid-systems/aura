...
| `tests/core/test_*.cpp` | 529 | Preferred destination suites |
| **Total scanned** | **529** | |
...
| `edsl_hygiene` | EDSL / macro hygiene / reflect | 0 | 0 | 34 | 34 | P1 — domain hygiene suite exists |
...
### `edsl_hygiene` — EDSL / macro hygiene / reflect (34)
