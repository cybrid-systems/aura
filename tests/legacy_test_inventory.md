...
| `tests/core/test_*.cpp` | 466 | Preferred destination suites |
| **Total scanned** | **466** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 130 | 130 | P0 — high volume; strong domain suite foothold |
...
| `jit_incremental` | JIT / AOT / incremental relower | 0 | 0 | 46 | 46 | P2 — link-profile heavy; migrate AC smoke first |
| `shape_soa` | Shape / SoA / column layout | 0 | 0 | 21 | 21 | P2 — small-medium; soa_batch precedent |
| `observability` | Observability / metrics / query:*-stats | 0 | 0 | 107 | 107 | P2 — often thin schema probes; collapse into obs matrix |
...
### `mutation_dirty` — Mutation / dirty propagation / provenance (130)
...
- `tests/serve/test_mutation_safety_snapshot_steal_2184.cpp` (#2184) [domain_suite, theme_serve] — AC1: mutation_safety_snapshot used by is_at_mutation_boundary_safe +
...
### `observability` — Observability / metrics / query:*-stats (107)
