...
| `tests/core/test_*.cpp` | 576 | Preferred destination suites |
| **Total scanned** | **576** | |
...
|-------|-------|-------:|-----:|-------:|------:|--------------------|
| `arena_compaction` | Arena / compaction / GC | 0 | 0 | 63 | 63 | P0 — well-contained, batch drivers already exist |
...
### `arena_compaction` — Arena / compaction / GC (63)
