...
| `tests/core/test_*.cpp` | 625 | Preferred destination suites |
| **Total scanned** | **625** | |
...
| `shape_soa` | Shape / SoA / column layout | 0 | 0 | 35 | 35 | P2 — small-medium; soa_batch precedent |
...
### `shape_soa` — Shape / SoA / column layout (35)
