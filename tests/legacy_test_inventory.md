...
| `tests/core/test_*.cpp` | 424 | Preferred destination suites |
| **Total scanned** | **424** | |
...
|-------|-------|-------:|-----:|-------:|------:|--------------------|
| `arena_compaction` | Arena / compaction / GC | 0 | 0 | 42 | 42 | P0 — well-contained, batch drivers already exist |
...
### `arena_compaction` — Arena / compaction / GC (42)
