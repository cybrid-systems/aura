...
| `tests/core/test_*.cpp` | 710 | Preferred destination suites |
| **Total scanned** | **710** | |
...
| `fiber_orch` | Fiber / orchestration / steal / Guard | 0 | 0 | 79 | 79 | P1 — domain suite already collapses many obs gates |
...
### `fiber_orch` — Fiber / orchestration / steal / Guard (79)
