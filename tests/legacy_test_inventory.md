...
| `tests/core/test_*.cpp` | 493 | Preferred destination suites |
| **Total scanned** | **493** | |
...
| `jit_incremental` | JIT / AOT / incremental relower | 0 | 0 | 52 | 52 | P2 — link-profile heavy; migrate AC smoke first |
