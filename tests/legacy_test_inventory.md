...
| `tests/core/test_*.cpp` | 496 | Preferred destination suites |
| **Total scanned** | **496** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 144 | 144 | P0 — high volume; strong domain suite foothold |
