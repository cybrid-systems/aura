...
| `tests/core/test_*.cpp` | 494 | Preferred destination suites |
| **Total scanned** | **494** | |
...
| `jit_incremental` | JIT / AOT / incremental relower | 0 | 0 | 53 | 53 | P2 — link-profile heavy; migrate AC smoke first |
...
### `jit_incremental` — JIT / AOT / incremental relower (53)
