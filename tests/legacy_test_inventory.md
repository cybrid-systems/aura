...
| `tests/core/test_*.cpp` | 368 | Preferred destination suites |
| **Total scanned** | **368** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 95 | 95 | P0 — high volume; strong domain suite foothold |
...
### `mutation_dirty` — Mutation / dirty propagation / provenance (95)
