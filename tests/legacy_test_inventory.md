...
| `tests/core/test_*.cpp` | 366 | Preferred destination suites |
| **Total scanned** | **366** | |
...
| `jit_incremental` | JIT / AOT / incremental relower | 0 | 0 | 36 | 36 | P2 — link-profile heavy; migrate AC smoke first |
