...
| `tests/core/test_*.cpp` | 482 | Preferred destination suites |
| **Total scanned** | **482** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 137 | 137 | P0 — high volume; strong domain suite foothold |
...
### `mutation_dirty` — Mutation / dirty propagation / provenance (137)
