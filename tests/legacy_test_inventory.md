...
| `tests/core/test_*.cpp` | 351 | Preferred destination suites |
| **Total scanned** | **351** | |
...
| `jit_incremental` | JIT / AOT / incremental relower | 0 | 0 | 34 | 34 | P2 — link-profile heavy; migrate AC smoke first |
