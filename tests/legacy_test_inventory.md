...
| `observability` | Observability / metrics / query:*-stats | 0 | 0 | 115 | 115 | P2 — often thin schema probes; collapse into obs matrix |
...
### `observability` — Observability / metrics / query:*-stats (115)
