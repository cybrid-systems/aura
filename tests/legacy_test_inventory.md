...
**Generated:** 2026-08-05 by `scripts/tools/inventory_legacy_tests.py`
...
| `tests/core/test_*.cpp` | 768 | Preferred destination suites |
| **Total scanned** | **768** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 221 | 221 | P0 — high volume; strong domain suite foothold |
...
### `mutation_dirty` — Mutation / dirty propagation / provenance (221)
...
- `tests/compiler/test_module_require_freevar.cpp` (—) [domain_suite, theme_compiler] — AC1: (require "std/mutate" all:) inside non-std module → closures
...
- `tests/compiler/test_hot_strategy.cpp` (—) [domain_suite, theme_compiler] — AC1: hot-strategy:swap! rebinds named strategy; call sees new body
