...
| `tests/core/test_*.cpp` | 630 | Preferred destination suites |
| **Total scanned** | **630** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 184 | 184 | P0 — high volume; strong domain suite foothold |
...
| `shape_soa` | Shape / SoA / column layout | 0 | 0 | 36 | 36 | P2 — small-medium; soa_batch precedent |
...
### `mutation_dirty` — Mutation / dirty propagation / provenance (184)
...
### `shape_soa` — Shape / SoA / column layout (36)
...
### `observability` — Observability / metrics / query:*-stats (124)
