...
| `tests/core/test_*.cpp` | 465 | Preferred destination suites |
| **Total scanned** | **465** | |
...
| `fiber_orch` | Fiber / orchestration / steal / Guard | 0 | 0 | 46 | 46 | P1 — domain suite already collapses many obs gates |
