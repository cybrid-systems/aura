...
| `tests/core/test_*.cpp` | 528 | Preferred destination suites |
| **Total scanned** | **528** | |
...
| `edsl_hygiene` | EDSL / macro hygiene / reflect | 0 | 0 | 33 | 33 | P1 — domain hygiene suite exists |
...
### `edsl_hygiene` — EDSL / macro hygiene / reflect (33)
