...
| `tests/core/test_*.cpp` | 575 | Preferred destination suites |
| **Total scanned** | **575** | |
...
|-------|-------|-------:|-----:|-------:|------:|--------------------|
| `arena_compaction` | Arena / compaction / GC | 0 | 0 | 62 | 62 | P0 — well-contained, batch drivers already exist |
...
### `arena_compaction` — Arena / compaction / GC (62)
