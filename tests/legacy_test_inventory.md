...
| `tests/core/test_*.cpp` | 850 | Preferred destination suites |
| **Total scanned** | **850** | |
...
|-------|-------|-------:|-----:|-------:|------:|--------------------|
| `arena_compaction` | Arena / compaction / GC | 0 | 0 | 86 | 86 | P0 — well-contained, batch drivers already exist |
...
### `arena_compaction` — Arena / compaction / GC (86)
