...
| `tests/core/test_*.cpp` | 530 | Preferred destination suites |
| **Total scanned** | **530** | |
...
| `edsl_hygiene` | EDSL / macro hygiene / reflect | 0 | 0 | 35 | 35 | P1 — domain hygiene suite exists |
...
### `edsl_hygiene` — EDSL / macro hygiene / reflect (35)
