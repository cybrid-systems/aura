...
| `tests/core/test_*.cpp` | 379 | Preferred destination suites |
| **Total scanned** | **379** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 102 | 102 | P0 — high volume; strong domain suite foothold |
...
### `mutation_dirty` — Mutation / dirty propagation / provenance (102)
