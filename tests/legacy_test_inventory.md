...
| `tests/core/test_*.cpp` | 414 | Preferred destination suites |
| **Total scanned** | **414** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 117 | 117 | P0 — high volume; strong domain suite foothold |
...
### `mutation_dirty` — Mutation / dirty propagation / provenance (117)
