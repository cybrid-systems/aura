...
| `tests/core/test_*.cpp` | 531 | Preferred destination suites |
| **Total scanned** | **531** | |
...
| `edsl_hygiene` | EDSL / macro hygiene / reflect | 0 | 0 | 36 | 36 | P1 — domain hygiene suite exists |
...
### `edsl_hygiene` — EDSL / macro hygiene / reflect (36)
...
### `observability` — Observability / metrics / query:*-stats (117)
