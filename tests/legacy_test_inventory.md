...
| `tests/core/test_*.cpp` | 364 | Preferred destination suites |
| **Total scanned** | **364** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 93 | 93 | P0 — high volume; strong domain suite foothold |
...
### `mutation_dirty` — Mutation / dirty propagation / provenance (93)
