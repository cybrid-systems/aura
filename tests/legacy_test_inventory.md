...
| `tests/core/test_*.cpp` | 767 | Preferred destination suites |
| **Total scanned** | **767** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 220 | 220 | P0 — high volume; strong domain suite foothold |
...
| `uncategorized` | Uncategorized / mixed | 0 | 0 | 54 | 54 | P3 — review case-by-case |
...
- `tests/compiler/test_batch_dirty_discipline_2615.cpp` → theme `mutation_dirty`
...
- `tests/compiler/test_batch_dirty_discipline_2615.cpp`
...
- `tests/compiler/test_castop_typed_meta_2624.cpp`
...
- `tests/compiler/test_coercion_unify_incomplete_skip_2620.cpp`
...
- `tests/compiler/test_composite_auto_partial_from_cone_2610.cpp`
...
- `tests/core/test_hot_children_columnar_2614.cpp`
...
- `tests/compiler/test_occurrence_dirty_key_authority_2622.cpp`
- `tests/compiler/test_occurrence_goal_epoch_table_2278.cpp`
- `tests/compiler/test_occurrence_goal_persist_rehydrate_2608.cpp`
...
- `tests/compiler/test_soa_residual_production_smoke_2618.cpp`
...
- `tests/serve/test_steal_densify_linear_type_hard_and_2609.cpp`
...
- `tests/compiler/test_batch_dirty_discipline_2615.cpp` (#2615) [batch_driver, domain_suite, theme_compiler] — AC1: Multi-block production sites use batch; fence +1 for N blocks
...
- `tests/compiler/test_coercion_unify_incomplete_skip_2620.cpp` (#2620) [domain_suite, theme_compiler] — AC1: Soft + incomplete → applied==0, no CoercionNode
...
- `tests/compiler/test_composite_auto_partial_from_cone_2610.cpp` (#2610) [domain_suite, theme_compiler] — AC1: Production + cone dirty + empty CS + !txn_dirty → hard reject;
...
- `tests/compiler/test_occurrence_dirty_key_authority_2622.cpp` (#2622) [domain_suite, theme_compiler] — AC1: cond shape path + cache key miss wiring present
...
- `tests/orch/test_join_drain_reclaim_2227.cpp` (#2227) [large, domain_suite, theme_orch] — AC1: residual + reclaim counters bump when non-yielding body +
...
- `tests/serve/test_steal_densify_linear_type_hard_and_2609.cpp` (#2609) [domain_suite, theme_serve] — AC1: Inject residual OR linear force under Hard → Cancel+Done; fail +1
...
### `linear_ownership` — Linear ownership / borrow / consume (21)
...
- `tests/compiler/test_castop_typed_meta_2624.cpp` (#2624) [domain_suite, theme_compiler] — AC1: Non-elided Coercion/CastOp lower stamps typed meta (type ids/tags)
...
- `tests/compiler/test_production_hardening_985.cpp` (#985) [domain_suite, theme_compiler] — test_production_hardening_985_1013.cpp — Issues #985–#1013 Phase 1
...
- `tests/compiler/test_selfevo_bugfix_941.cpp` (#941) [domain_suite, theme_compiler] — test_selfevo_bugfix_941_967.cpp — Issues #941–#967 Phase 1
...
- `tests/compiler/test_value_tag_hotpath_ban_2616.cpp` (#2616) [domain_suite, theme_compiler] — AC1: Zero classify_eval_value_tag in production hot sources (gate)
...
### `uncategorized` — Uncategorized / mixed (54)
...
- `tests/compiler/test_production_hardening_batch.cpp` (—) [batch_driver, domain_suite, theme_compiler] — test_production_hardening_batch.cpp — thematic multi-TU batch
