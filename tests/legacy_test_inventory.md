...
| `tests/core/test_*.cpp` | 380 | Preferred destination suites |
| **Total scanned** | **380** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 103 | 103 | P0 — high volume; strong domain suite foothold |
...
### `mutation_dirty` — Mutation / dirty propagation / provenance (103)
