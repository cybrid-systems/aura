...
| `tests/core/test_*.cpp` | 367 | Preferred destination suites |
| **Total scanned** | **367** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 94 | 94 | P0 — high volume; strong domain suite foothold |
...
| `jit_incremental` | JIT / AOT / incremental relower | 0 | 0 | 37 | 37 | P2 — link-profile heavy; migrate AC smoke first |
...
### `arena_compaction` — Arena / compaction / GC (36)
...
### `mutation_dirty` — Mutation / dirty propagation / provenance (94)
...
### `jit_incremental` — JIT / AOT / incremental relower (37)
