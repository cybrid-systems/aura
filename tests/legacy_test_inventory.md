...
| `tests/core/test_*.cpp` | 825 | Preferred destination suites |
| **Total scanned** | **825** | |
...
| `jit_incremental` | JIT / AOT / incremental relower | 0 | 0 | 79 | 79 | P2 — link-profile heavy; migrate AC smoke first |
...
### `jit_incremental` — JIT / AOT / incremental relower (79)
