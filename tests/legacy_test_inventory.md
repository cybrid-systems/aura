...
| `tests/core/test_*.cpp` | 449 | Preferred destination suites |
| **Total scanned** | **449** | |
...
|-------|-------|-------:|-----:|-------:|------:|--------------------|
| `arena_compaction` | Arena / compaction / GC | 0 | 0 | 46 | 46 | P0 — well-contained, batch drivers already exist |
...
### `arena_compaction` — Arena / compaction / GC (46)
