...
| `tests/core/test_*.cpp` | 464 | Preferred destination suites |
| **Total scanned** | **464** | |
...
| `fiber_orch` | Fiber / orchestration / steal / Guard | 0 | 0 | 45 | 45 | P1 — domain suite already collapses many obs gates |
...
### `fiber_orch` — Fiber / orchestration / steal / Guard (45)
