...
| `tests/core/test_*.cpp` | 634 | Preferred destination suites |
| **Total scanned** | **634** | |
...
| `shape_soa` | Shape / SoA / column layout | 0 | 0 | 38 | 38 | P2 — small-medium; soa_batch precedent |
...
### `shape_soa` — Shape / SoA / column layout (38)
