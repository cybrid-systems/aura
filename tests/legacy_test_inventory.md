...
| `tests/core/test_*.cpp` | 605 | Preferred destination suites |
| **Total scanned** | **605** | |
...
| `shape_soa` | Shape / SoA / column layout | 0 | 0 | 30 | 30 | P2 — small-medium; soa_batch precedent |
...
### `shape_soa` — Shape / SoA / column layout (30)
