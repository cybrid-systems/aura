...
| `tests/core/test_*.cpp` | 571 | Preferred destination suites |
| **Total scanned** | **571** | |
...
| `fiber_orch` | Fiber / orchestration / steal / Guard | 0 | 0 | 61 | 61 | P1 — domain suite already collapses many obs gates |
...
### `fiber_orch` — Fiber / orchestration / steal / Guard (61)
