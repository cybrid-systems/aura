...
| `tests/core/test_*.cpp` | 570 | Preferred destination suites |
| **Total scanned** | **570** | |
...
| `fiber_orch` | Fiber / orchestration / steal / Guard | 0 | 0 | 60 | 60 | P1 — domain suite already collapses many obs gates |
...
### `fiber_orch` — Fiber / orchestration / steal / Guard (60)
