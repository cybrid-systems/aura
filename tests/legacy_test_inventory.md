...
| `tests/core/test_*.cpp` | 486 | Preferred destination suites |
| **Total scanned** | **486** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 140 | 140 | P0 — high volume; strong domain suite foothold |
| `fiber_orch` | Fiber / orchestration / steal / Guard | 0 | 0 | 50 | 50 | P1 — domain suite already collapses many obs gates |
...
### `mutation_dirty` — Mutation / dirty propagation / provenance (140)
