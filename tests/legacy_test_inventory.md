...
| `tests/core/test_*.cpp` | 826 | Preferred destination suites |
| **Total scanned** | **826** | |
...
| `jit_incremental` | JIT / AOT / incremental relower | 0 | 0 | 80 | 80 | P2 — link-profile heavy; migrate AC smoke first |
...
### `jit_incremental` — JIT / AOT / incremental relower (80)
...
- `tests/compiler/test_tco_dead_block_accumulation.cpp` (—) [domain_suite, theme_compiler] — AC1: source has sweep_dead_blocks + tco_dead_block_total; cites #2831
