...
| `tests/core/test_*.cpp` | 434 | Preferred destination suites |
| **Total scanned** | **434** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 122 | 122 | P0 — high volume; strong domain suite foothold |
