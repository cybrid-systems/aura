...
| `tests/core/test_*.cpp` | 522 | Preferred destination suites |
| **Total scanned** | **522** | |
...
| `observability` | Observability / metrics / query:*-stats | 0 | 0 | 114 | 114 | P2 — often thin schema probes; collapse into obs matrix |
