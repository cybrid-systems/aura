...
| `tests/core/test_*.cpp` | 655 | Preferred destination suites |
| **Total scanned** | **655** | |
...
| `uncategorized` | Uncategorized / mixed | 0 | 0 | 38 | 38 | P3 — review case-by-case |
...
### `uncategorized` — Uncategorized / mixed (38)
