...
**Generated:** 2026-09-13 by `scripts/tools/inventory_legacy_tests.py`
...
| `tests/core/test_*.cpp` | 887 | Preferred destination suites |
| **Total scanned** | **887** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 271 | 271 | P0 — high volume; strong domain suite foothold |
...
### `mutation_dirty` — Mutation / dirty propagation / provenance (271)
...
- `tests/compiler/test_security_posture_trail.cpp` (—) [domain_suite, theme_compiler] — AC1: posture returns schema-2534
