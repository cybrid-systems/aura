...
| `tests/core/test_*.cpp` | 801 | Preferred destination suites |
| **Total scanned** | **801** | |
...
| `edsl_hygiene` | EDSL / macro hygiene / reflect | 0 | 0 | 48 | 48 | P1 — domain hygiene suite exists |
...
### `edsl_hygiene` — EDSL / macro hygiene / reflect (48)
