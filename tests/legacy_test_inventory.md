...
| `tests/core/test_*.cpp` | 525 | Preferred destination suites |
| **Total scanned** | **525** | |
...
| `edsl_hygiene` | EDSL / macro hygiene / reflect | 0 | 0 | 31 | 31 | P1 — domain hygiene suite exists |
...
### `edsl_hygiene` — EDSL / macro hygiene / reflect (31)
