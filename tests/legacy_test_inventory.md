...
| `tests/core/test_*.cpp` | 535 | Preferred destination suites |
| **Total scanned** | **535** | |
...
|-------|-------|-------:|-----:|-------:|------:|--------------------|
| `arena_compaction` | Arena / compaction / GC | 0 | 0 | 55 | 55 | P0 — well-contained, batch drivers already exist |
...
### `arena_compaction` — Arena / compaction / GC (55)
