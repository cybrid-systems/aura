...
| `tests/core/test_*.cpp` | 648 | Preferred destination suites |
| **Total scanned** | **648** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 189 | 189 | P0 — high volume; strong domain suite foothold |
...
| `jit_incremental` | JIT / AOT / incremental relower | 0 | 0 | 64 | 64 | P2 — link-profile heavy; migrate AC smoke first |
...
### `mutation_dirty` — Mutation / dirty propagation / provenance (189)
...
### `fiber_orch` — Fiber / orchestration / steal / Guard (66)
...
### `linear_ownership` — Linear ownership / borrow / consume (15)
...
### `jit_incremental` — JIT / AOT / incremental relower (64)
...
### `shape_soa` — Shape / SoA / column layout (40)
...
### `uncategorized` — Uncategorized / mixed (35)
