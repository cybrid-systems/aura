...
| `tests/core/test_*.cpp` | 461 | Preferred destination suites |
| **Total scanned** | **461** | |
...
| `fiber_orch` | Fiber / orchestration / steal / Guard | 0 | 0 | 44 | 44 | P1 — domain suite already collapses many obs gates |
...
### `fiber_orch` — Fiber / orchestration / steal / Guard (44)
