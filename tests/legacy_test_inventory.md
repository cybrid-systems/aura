...
| `tests/core/test_*.cpp` | 483 | Preferred destination suites |
| **Total scanned** | **483** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 138 | 138 | P0 — high volume; strong domain suite foothold |
...
### `mutation_dirty` — Mutation / dirty propagation / provenance (138)
