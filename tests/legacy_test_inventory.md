...
| `tests/core/test_*.cpp` | 549 | Preferred destination suites |
| **Total scanned** | **549** | |
...
|-------|-------|-------:|-----:|-------:|------:|--------------------|
| `arena_compaction` | Arena / compaction / GC | 0 | 0 | 57 | 57 | P0 — well-contained, batch drivers already exist |
...
### `arena_compaction` — Arena / compaction / GC (57)
