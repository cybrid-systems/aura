...
| `tests/core/test_*.cpp` | 685 | Preferred destination suites |
| **Total scanned** | **685** | |
...
| `fiber_orch` | Fiber / orchestration / steal / Guard | 0 | 0 | 72 | 72 | P1 — domain suite already collapses many obs gates |
...
### `fiber_orch` — Fiber / orchestration / steal / Guard (72)
