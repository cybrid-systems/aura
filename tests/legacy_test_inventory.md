...
| `tests/core/test_*.cpp` | 629 | Preferred destination suites |
| **Total scanned** | **629** | |
...
| `mutation_dirty` | Mutation / dirty propagation / provenance | 0 | 0 | 183 | 183 | P0 — high volume; strong domain suite foothold |
...
### `mutation_dirty` — Mutation / dirty propagation / provenance (183)
