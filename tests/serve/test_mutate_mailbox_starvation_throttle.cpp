...
//   - tests/serve/test_mutate_mailbox_starvation_throttle.cpp (this).
//
...
int run_test_mutate_mailbox_starvation_throttle() {
    ...
    // ── AC4: source-cite list ────────────────────────────────────────
    {
        ...
        std::println("  - tests/serve/test_mutate_mailbox_starvation_throttle.cpp.");
...
int main() {
    return run_test_mutate_mailbox_starvation_throttle();
}
#endif
