...
static void ac4_source_cite_extensions() {
    ...
    const auto t2115 = read_file("tests/serve/test_depth_safe_mutation_boundary_steal.cpp");
    const auto t2118 = read_file("tests/serve/test_orch_agent_mutation_boundary.cpp");
...
int main() {
    return run_test_orch_soft_boundary_unified();
}
#endif
