...
def _rows(mb: str, health: str, reh: str, build: str, query: str, obs: str, allow: str) -> list[str]:
    ...
    if _count(mb, "restore_or_clear_occurrence_to_entry(") != 5:
        fails.append("AC2: #3158 restore site count != 5 (4 abort + persist-reject #3687)")
...
def main() -> int:
    ...
    if args.self_test:
        sample_mb = (
            ...
            + "restore_or_clear_occurrence_to_entry(e)\n"
