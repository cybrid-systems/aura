...
def main() -> int:
    ...
    # AC5 query + gate (Issue #3906: obs_eval is the single SSOT)
    must("schema-2363", "AC5", q)
    must("issue-2363", "AC5", q)
    must("general-object-pin-adopt-complete-wired", "AC5", q)
    must("general-object-pin-adopt-site-count", "AC5", q)
    must("kGeneralObjectPinAdoptSiteCount", "AC5", q)
