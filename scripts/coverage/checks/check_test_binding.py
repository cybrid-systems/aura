...
Usage:
  python3 scripts/coverage/checks/check_test_binding.py
  python3 scripts/coverage/checks/check_test_binding.py --base origin/main
  python3 scripts/coverage/checks/check_test_binding.py --files a.cpp b.cpp
  python3 scripts/coverage/checks/check_test_binding.py --require-name-mention   # stricter
