...
Usage:
  ...
  python3 scripts/coverage/checks/check_register_render_hot_prim_coverage.py --strict
"""
...
def check() -> list[str]:
    ...
    _must(
        "#2626" in _read("scripts/coverage/checks/check_register_render_hot_prim_coverage.py"),
