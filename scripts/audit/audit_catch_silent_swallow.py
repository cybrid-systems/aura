...
Usage:
  python3 scripts/audit/audit_catch_silent_swallow.py          # report, exit 0
  python3 scripts/audit/audit_catch_silent_swallow.py --strict # exit 1 if unmarked
  python3 scripts/audit/audit_catch_silent_swallow.py --json
