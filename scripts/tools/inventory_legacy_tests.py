...
Usage:
  python3 scripts/tools/inventory_legacy_tests.py           # write inventory
  python3 scripts/tools/inventory_legacy_tests.py --check   # fail if stale
  python3 scripts/tools/inventory_legacy_tests.py --json path.json  # also dump JSON
...
def render_markdown(entries: list[TestEntry]) -> str:
    ...
    a(f"**Generated:** {today} by `scripts/tools/inventory_legacy_tests.py`")
    ...
    a(
        ...
        "(`scripts/tools/classify_test_issues.py`)"
    )
    ...
    a("- `python3 scripts/tools/inventory_legacy_tests.py --check` stays green after refresh.")
    ...
    a("")
    a("```bash")
    a("python3 scripts/tools/inventory_legacy_tests.py")
    a("python3 scripts/tools/inventory_legacy_tests.py --check")
    a("```")
    a("")
    a(
        "The coarser Phase-2 5-domain classifier remains available as "
        "`scripts/tools/classify_test_issues.py` for historical comparison; **this "
