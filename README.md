...
| 模型 | 通过率 | 耗时 | 短板 |
|:----|:------:|:----:|:-----|
| 🥇 Grok 4.3 | **78/85 (91.8%)** | ~13min | algorithm (3), ffi, type (2) |
| 🥇 DeepSeek v4 Flash | **77/85 (90.6%)** | ~46min | algorithm (2), ffi (2), type (2) |
| 🥈 MiniMax M2.7 | **76/85 (89.4%)** | ~23min | algorithm (2), ffi (3), network, type (2) |
