...
export enum class TokenKind { Integer, Identifier, LParen, RParen, EndOfFile, Error };
...
private:
    Token advance(); Token read_number(); Token read_identifier(); void skip_ws(); Token make_tok(TokenKind k, std::string_view t);
