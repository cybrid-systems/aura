...
export inline EvalValue make_bool(bool v) {
    return EvalValue(std::in_place_index<2>, v);
}
export inline EvalValue make_string(std::uint64_t idx) {
    return EvalValue(std::in_place_index<3>, StringRef{idx});
}
export inline EvalValue make_pair(std::uint64_t idx) {
    return EvalValue(std::in_place_index<4>, PairRef{idx});
}
export inline EvalValue make_closure(std::uint64_t id) {
    return EvalValue(std::in_place_index<5>, ClosureRef{id});
}
export inline EvalValue make_cell(std::uint64_t id) {
    return EvalValue(std::in_place_index<6>, CellRef{id});
}
export inline EvalValue make_vector(std::uint64_t idx) {
    return EvalValue(std::in_place_index<7>, VectorRef{idx});
}
export inline EvalValue make_hash(std::uint64_t idx) {
    return EvalValue(std::in_place_index<8>, HashRef{idx});
}
export inline EvalValue make_float(double v) {
    return EvalValue(std::in_place_index<9>, v);
}
export inline EvalValue make_primitive(std::size_t slot) {
    return EvalValue(std::in_place_index<10>, PrimitiveRef{slot});
}
export inline EvalValue make_module(std::uint64_t idx) {
    return EvalValue(std::in_place_index<11>, ModuleRef{idx});
}
export inline EvalValue make_error(std::uint64_t idx) {
    return EvalValue(std::in_place_index<12>, ErrorRef{idx});
}
export inline EvalValue make_linear(std::uint64_t id) {
    return EvalValue(std::in_place_index<13>, LinearRef{id});
}

export inline bool is_linear(const EvalValue& v) noexcept {
    return std::holds_alternative<LinearRef>(v);
}
export inline std::uint64_t as_linear_id(const EvalValue& v) {
    return std::get<LinearRef>(v).id;
}

export inline EvalValue make_void() {
    return EvalValue(std::in_place_index<0>);
}
...
export inline bool is_string(const EvalValue& v) noexcept {
    return std::holds_alternative<StringRef>(v);
}
export inline bool is_pair(const EvalValue& v) noexcept {
    return std::holds_alternative<PairRef>(v);
}
export inline bool is_closure(const EvalValue& v) noexcept {
    return std::holds_alternative<ClosureRef>(v);
}
export inline bool is_cell(const EvalValue& v) noexcept {
    return std::holds_alternative<CellRef>(v);
}
export inline bool is_vector(const EvalValue& v) noexcept {
    return std::holds_alternative<VectorRef>(v);
}
export inline bool is_hash(const EvalValue& v) noexcept {
    return std::holds_alternative<HashRef>(v);
}
export inline bool is_float(const EvalValue& v) noexcept {
    return std::holds_alternative<double>(v);
}
export inline bool is_primitive(const EvalValue& v) noexcept {
    return std::holds_alternative<PrimitiveRef>(v);
}
export inline bool is_module(const EvalValue& v) noexcept {
    return std::holds_alternative<ModuleRef>(v);
}
export inline bool is_error(const EvalValue& v) noexcept {
    return std::holds_alternative<ErrorRef>(v);
}

export inline std::int64_t as_int(const EvalValue& v) {
    return std::get<std::int64_t>(v);
}
export inline bool as_bool(const EvalValue& v) {
    return std::get<bool>(v);
}
export inline std::uint64_t as_string_idx(const EvalValue& v) {
    return std::get<StringRef>(v).index;
}
export inline std::uint64_t as_pair_idx(const EvalValue& v) {
    return std::get<PairRef>(v).index;
}
export inline std::uint64_t as_closure_id(const EvalValue& v) {
    return std::get<ClosureRef>(v).id;
}
export inline std::uint64_t as_cell_id(const EvalValue& v) {
    return std::get<CellRef>(v).id;
}
export inline std::uint64_t as_vector_idx(const EvalValue& v) {
    return std::get<VectorRef>(v).index;
}
export inline std::uint64_t as_hash_idx(const EvalValue& v) {
    return std::get<HashRef>(v).index;
}
export inline double as_float(const EvalValue& v) {
    return std::get<double>(v);
}
export inline std::size_t as_primitive_slot(const EvalValue& v) {
    return std::get<PrimitiveRef>(v).slot;
}
export inline std::uint64_t as_module_idx(const EvalValue& v) {
    return std::get<ModuleRef>(v).index;
}
export inline std::uint64_t as_error_idx(const EvalValue& v) {
    return std::get<ErrorRef>(v).index;
}
