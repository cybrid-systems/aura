...
public:
    ...
    // Issue #2935 / #3055 / #3057 / #3210: auto-register known intermediate +
    ...
    // Issue #2091 / #3267: publish the live env_frame_version + max
    ...
    // Takes shared_lock(env_frames_mtx_). compact / truncate already
    // hold unique_lock and must use the holding-lock sibling
    // (mutex is non-recursive).
    void publish_live_env_linear_to_bridge() const noexcept;
    void publish_live_env_linear_to_bridge_holding_env_lock() const noexcept;
