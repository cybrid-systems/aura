...
void register_reflect_and_type_primitives(PrimRegistrar add, std::pmr::vector<Pair>& pairs,
    ...
    add("reflect-type",
        [&pairs, &string_heap, &type_registry](std::span<const EvalValue> a) -> EvalValue {
    ...
    // Issue #1276 Phase 1: query:reflect-schema-stats — Agent-visible
