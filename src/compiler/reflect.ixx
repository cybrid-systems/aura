...
// Enums with uint8_t underlying type are serialized as integers.
// Nested structs, vectors, and other complex types serialize as "null".
//
...
// ── Convenience: auto_to_json for aura::diag::Diagnostic ──────
export inline std::string diagnostic_to_json(const aura::diag::Diagnostic& d) {
    return auto_to_json(d);
}
