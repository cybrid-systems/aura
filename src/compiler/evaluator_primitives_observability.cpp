...
const std::vector<std::string> kObservabilityStatsPrimitives = {
    ...
    // Issue #2523 — focused workspace_mtx contention for Agent self-throttle
    "query:workspace-mtx-contention-stats",
    ...
    // Issue #2917 — Closed-loop agent:recover-from-error status / success rate
    "query:agent-recovery-stats",
    ...
    // Issue #1882 — AOT hot-update TypedMutationAudit surface
