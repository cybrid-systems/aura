...
export using ::aura::ast::restamp_hot_cone_held_overflow;
...
export using ::aura::ast::reset_unified_restamp_3019_for_test;
...
public:
    ...
    // Issue #2449: param_data_ is a shared arena (not per-node SoA
    // alone). Grown by builder insert under the single-threaded
...
public:
    ...
    replace_pattern_temp_arena_corruption_prevented_total() const noexcept {
        return replace_pattern_temp_arena_corruption_prevented_total_.load(
            std::memory_order_relaxed);
    }
