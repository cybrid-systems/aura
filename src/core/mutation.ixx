...
namespace aura::core {
template <> struct NullIdCheck<aura::ast::NodeId> {
...
mutation_error_to_aura_error_kind(MutationError err) noexcept {
    switch (err) {
        case MutationError::NotCommitted:
            return ::aura::core::AuraErrorKind::MutationNotCommitted;
        case MutationError::NoRollbackData:
            return ::aura::core::AuraErrorKind::MutationNoRollbackData;
        case MutationError::InvalidTarget:
            return ::aura::core::AuraErrorKind::MutationInvalidTarget;
        case MutationError::InvalidParent:
            return ::aura::core::AuraErrorKind::MutationInvalidParent;
        case MutationError::InvalidField:
            return ::aura::core::AuraErrorKind::MutationInvalidField;
        case MutationError::UnknownStructuralOp:
            return ::aura::core::AuraErrorKind::MutationUnknownStructuralOp;
        case MutationError::OutOfRange:
            return ::aura::core::AuraErrorKind::MutationOutOfRange;
    }
...
namespace mutation {
    ...
    validate_rollback_record(const Rec& rec, std::size_t tag_size) noexcept {
    ...
    export template <RollbackCapable Rec>
    [[nodiscard]] std::expected<RollbackKind, MutationError>
    classify_rollback(const Rec& rec) noexcept {
        if (rec.has_subtree_rollback)
    ...
    public:
        void reset_identity(std::uint32_t parent_layer, std::uint64_t cow_epoch,
    ...
    export std::optional<std::string> lookup_custom_predicate_type(const std::string& pred_name);
