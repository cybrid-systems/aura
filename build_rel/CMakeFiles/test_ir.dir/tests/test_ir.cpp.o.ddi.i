# 0 "/home/dev/code/aura/tests/test_ir.cpp"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/dev/code/aura/tests/test_ir.cpp"
import std;
import aura.core;
...
bool test_arena_stats() {
    ...
    if (after.capacity < 4096) return false;
...
int main() {
    ...
    test_const_fold("(+ 1 (* 2 3))", "7", 2, "nested_const");
    test_const_fold("(if 1 42 0)", "42", 2, "if_condition_const");
    test_const_fold("(= 1 1)", "#t", 1, "eq_const");
    test_const_fold("(> 3 2)", "#t", 1, "gt_const");
    test_const_fold("(let ((x 10)) x)", "10", 0, "let_copy");
...
# 1019 "/home/dev/code/aura/tests/test_ir.cpp"
    {
