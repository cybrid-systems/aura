# 0 "/home/dev/code/aura/src/parser/lexer.ixx"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3
# 0 "<command-line>" 2
# 1 "/home/dev/code/aura/src/parser/lexer.ixx"
export module aura.parser.lexer;
import std;

namespace aura::parser {

export enum class TokenKind { Integer, Float, String, Identifier, LParen, RParen, Quote, QuasiQuote, Unquote, UnquoteSplicing, Dot, Ellipsis, Bool, EndOfFile, Error };
